...
export async function addLot(
  ...
  await logAction('lot.created', 'lot', nom, { categorie, palier, stock })
...
export async function updateLot(
  ...
  await logAction('lot.updated', 'lot', nom, { categorie, palier, stock }, id)
...
export async function deleteLot(id: string) {
  ...
  await logAction('lot.deleted', 'lot', lot?.nom ?? id, {}, id)
...
export async function toggleLotField(
  ...
  await logAction(actionName, 'lot', lot?.nom ?? id, { field, value }, id)
