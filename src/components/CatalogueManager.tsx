...
export default function CatalogueManager() {
  ...
  return (
    <div>
      ...
      {open && (
        <div className="card animate-fade-in" style={{ marginTop: '1rem', maxWidth: 560, borderLeft: '3px solid var(--brand)' }}>
          ...
          <form action={formAction} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div>
              ...
              <input id="lot-nom" name="nom" type="text" className="input" placeholder="ex : Dreame H15 Pro Aspirateur" required />
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: '0.75rem' }}>
              ...
              <div>
                ...
                <input id="lot-valeur" name="valeur_ar" type="number" className="input" placeholder="Optionnel" min={0} />
              </div>
            </div>
